...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    */
    KEYMAP(
            F(0),    KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0, KC_MINS,  KC_EQL,   KC_NO, KC_BSLS, \
    ...
    */
    KEYMAP(
         ...
         KC_TRNS, KC_VOLD, KC_VOLU,  KC_END, KC_TRNS, KC_TRNS, KC_TRNS, KC_PGUP,  KC_INS, KC_PSCR,   KC_UP, KC_BDEC, KC_BINC,  KC_DEL,          \
         KC_CAPS, KC_HOME, KC_TRNS, KC_PGDN, KC_TRNS, KC_TRNS, KC_LEFT, KC_DOWN,   KC_UP, KC_RGHT, KC_TRNS, KC_TRNS, KC_TRNS, KC_BTOG,          \
         KC_TRNS, KC_TRNS, KC_RTOG, KC_RMOD, KC_RHUI, KC_RHUD, KC_LEFT, KC_DOWN, KC_RSAI, KC_RSAD, KC_RVAI, KC_RVAD, KC_TRNS, KC_TRNS, KC_TRNS, \
